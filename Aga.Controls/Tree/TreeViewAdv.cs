...
//				throw new ArgumentNullException("node");
		...
		private void UpdateHScrollBar()
		{
            ...
            _hScrollBarIsActive = _hScrollBar.LargeChange < _hScrollBar.Maximum;
            _hScrollBar.Visible = _hScrollBarIsActive;
		...
		private void UpdateVScrollBar()
		{
            ...
            _vScrollBarIsActive = (RowCount > 0) && (_vScrollBar.LargeChange <= _vScrollBar.Maximum);
            _vScrollBar.Visible = _vScrollBarIsActive;

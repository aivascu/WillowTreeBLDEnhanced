...
namespace WillowTree.Plugins
{
    partial class ucGeneral
    {
        ...
        private StrictNumericUpDown BankSpace;
        private CustomControls.WTLabel labelGeneralCurrentLocation;
        private CustomControls.WTComboBox CurrentLocation;
        private StrictNumericUpDown Level;
        private CustomControls.WTLabel labelGeneralEquipSlots;
        private StrictNumericUpDown Experience;
        private StrictNumericUpDown EquipSlots;
        private StrictNumericUpDown Cash;
        private CustomControls.WTLabel labelGeneralBackpackSpace;
        private StrictNumericUpDown SkillPoints;
        private StrictNumericUpDown BackpackSpace;
        private StrictNumericUpDown SaveNumber;
